...
namespace AutoRouteModule.Core
{
    ...
    public class GridAStar3D
    {
            ...
            PathFindOptions? options = null)
        {
            ...
            //Int3 start = _grid.WorldToGrid(startWorld);
            //Int3 goal = _grid.WorldToGrid(goalWorld);


            // 시작점 검증 (첫 구간만)
            //Vector3 fromCheckPos = startWorld + startDirection.ToVector3() * voxelSize * 0.5f;
        ...
        public void InitOptions(float voxelSize, PathFindOptions? options)
        {
            ...
            _options.MinStraightDistance = Math.Max(voxelSize*2, _options.MinStraightDistance);
        }
